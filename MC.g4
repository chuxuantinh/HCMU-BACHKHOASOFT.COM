...
variable_list: variable COMMA variable_list | variable; //variable (COMMA variable)*;
variable: ID (LSB INTLIT RSB)?;   //type_declaration ID (COMMA ID)* ; //xem lai

//2.2 Function declaration:
function_declaration: (VOID| primitive_type| arraypointer_type) ID LB parameter_list? RB block_statement  ; // xem lại có khai bao bien ben trong func khong
parameter_list: parameter_declaration COMMA parameter_list | parameter_declaration;   // parameter_declaration (COMMA parameter_declaration)*;
parameter_declaration: primitive_type ID | primitive_type ID LSB RSB; //  primitive_type ID (LSB RSB)?
...
//7.8
block_statement: LP list_var_stmt? RP  ; // section 7.8;
